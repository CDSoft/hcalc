...
Handy Calc is also an application example for the [FUN](http://fun.cdsoft.fr) project. Its development process and methods are based on:
...
The current version is [Handy Calc 1.0.2](http://cdsoft.fr/hcalc/HandyCalc-1.0.2.tgz)
...
-   Download [HandyCalc-1.0.2.tgz](http://cdsoft.fr/hcalc/HandyCalc-1.0.2.tgz)
-   Unpack HandyCalc-1.0.2.tgz
-   Run make
...
==========
    ...
    +---------------------------------------------------------------------+
    |       H A N D Y   C A L C       |     v 1.0.2     | cdsoft.fr/hcalc |
    |---------------------------------------------------------------------|
    | Modes:                          | Numbers:                          |
...
Number types are automatically converted in a way to preserve the best precision. Integers are prefered to rational numbers and rational numbers are prefered to floating point numbers.
...
You can see in the previous example that the evaluation is lazy! Thanks to lazyness, functions can also be mutually recursive.
