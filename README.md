...
1.1.3</span>](http://cdelord.fr/hcalc/HandyCalc-1.1.3.tgz)
...
**Installation from sources on Linux or Windows:**
  ...
  - Download and unpack
    [HandyCalc-1.1.3.tgz](http://cdelord.fr/hcalc/HandyCalc-1.1.3.tgz)
  - Run make
      - `make` compiles `hcalc`
...
# Screenshot
    ...
    ┌─────────────────────────────────┬────────────────┬──────────────────┐
    │       H A N D Y   C A L C       │    v 1.1.3     │ cdelord.fr/hcalc │
    ├─────────────────────────────────┼────────────────┴──────────────────┤
    │ Modes:                          │ Numbers:                          │
