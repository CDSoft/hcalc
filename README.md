...
The current version is [Handy Calc 1.0.4](http://cdsoft.fr/hcalc/HandyCalc-1.0.4.tgz)
...
-   Download [HandyCalc-1.0.4.tgz](http://cdsoft.fr/hcalc/HandyCalc-1.0.4.tgz)
-   Unpack HandyCalc-1.0.4.tgz
-   Run make
    -   `make` compiles `hcalc`
...
==========
    ...
    +---------------------------------------------------------------------+
    |       H A N D Y   C A L C       |     v 1.0.4     | cdsoft.fr/hcalc |
    |---------------------------------------------------------------------|
    | Modes:                          | Numbers:                          |
